...
export default function StatusBar() {
  return (
    <div className="relative h-[44px] w-full">
      <span className="absolute left-[24px] top-[1px] flex h-[21px] w-[54px] items-center justify-center text-[15px] font-semibold text-black">
        9:41
      </span>
      ...
      <div className="absolute right-[5px] top-[7px] flex h-[13px] items-center gap-[6px]">
